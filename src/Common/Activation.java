  ...
  public static void initializeJavonet() {
    if (!Javonet.isActivated()) {
      ...
      try {
        ...
        AddEmbeddedDllReference("Tridion.ContentManager.CoreService.Client.dll");
        Javonet.addReference("System.ServiceModel");
        Javonet.addReference("System.Runtime.Serialization");
        Javonet.addReference("System.Xml.Linq");
        Javonet.addReference("System.Xml");
        Javonet.addReference("System");
        Javonet.addReference("System.IdentityModel");
