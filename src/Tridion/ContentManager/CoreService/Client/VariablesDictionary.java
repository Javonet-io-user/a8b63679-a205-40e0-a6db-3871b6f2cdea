...
public class VariablesDictionary extends Dictionary<java.lang.String, java.lang.String>
  ...
  public VariablesDictionary() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.VariablesDictionary");
  ...
  public VariablesDictionary(NObject handle) {
    super(handle);
