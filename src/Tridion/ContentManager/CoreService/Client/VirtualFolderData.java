...
public class VirtualFolderData extends OrganizationalItemData implements IExtensibleDataObject {
  protected NObject javonetHandle;
  /** SetProperty */
  @MethodTypeAnnotation(type = "SetField")
  public void setConfiguration(java.lang.String value) {
    try {
      javonetHandle.set("Configuration", value);
  ...
  public java.lang.String getConfiguration() {
    try {
      java.lang.String res = javonetHandle.get("Configuration");
      if (res == null) return "";
  ...
  public void setTypeSchema(LinkToSchemaData value) {
    try {
      javonetHandle.set("TypeSchema", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public LinkToSchemaData getTypeSchema() {
    try {
      Object res = javonetHandle.<NObject>get("TypeSchema");
  ...
  public VirtualFolderData() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.VirtualFolderData");
  ...
  public VirtualFolderData(NObject handle) {
    super(handle);
