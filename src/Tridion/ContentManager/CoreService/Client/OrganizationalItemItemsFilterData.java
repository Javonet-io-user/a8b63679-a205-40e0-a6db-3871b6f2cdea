...
public class OrganizationalItemItemsFilterData extends ItemsFilterData
  ...
  public void setNotBasedOnSchema(LinkToSchemaData value) {
    try {
      javonetHandle.set("NotBasedOnSchema", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public LinkToSchemaData getNotBasedOnSchema() {
    try {
      Object res = javonetHandle.<NObject>get("NotBasedOnSchema");
      if (res == null) return null;
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setShowNewItems(Nullable<java.lang.Boolean> value) {
    try {
      javonetHandle.set("ShowNewItems", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public Nullable<java.lang.Boolean> getShowNewItems() {
    try {
      Object res = javonetHandle.<NObject>get("ShowNewItems");
      if (res == null) return null;
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setFailIfNoAccessToItems(java.lang.Boolean value) {
    try {
      javonetHandle.set("FailIfNoAccessToItems", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.Boolean getFailIfNoAccessToItems() {
    try {
      java.lang.Boolean res = javonetHandle.get("FailIfNoAccessToItems");
  ...
  public OrganizationalItemItemsFilterData() {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New(
              "Tridion.ContentManager.CoreService.Client.OrganizationalItemItemsFilterData");
  ...
  public OrganizationalItemItemsFilterData(NObject handle) {
    super(handle);
