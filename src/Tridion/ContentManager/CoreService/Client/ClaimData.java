...
public class ClaimData implements IExtensibleDataObject {
  ...
  public ClaimData() {
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.ClaimData");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public ClaimData(NObject handle) {
