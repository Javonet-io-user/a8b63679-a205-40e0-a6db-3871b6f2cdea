...
public class LocationInfo extends Info implements IExtensibleDataObject {
  ...
  public void setOrganizationalItem(LinkToOrganizationalItemData value) {
    try {
      javonetHandle.set("OrganizationalItem", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public LinkToOrganizationalItemData getOrganizationalItem() {
    try {
      Object res = javonetHandle.<NObject>get("OrganizationalItem");
      if (res == null) return null;
      return new LinkToOrganizationalItemData((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public LocationInfo() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.LocationInfo");
