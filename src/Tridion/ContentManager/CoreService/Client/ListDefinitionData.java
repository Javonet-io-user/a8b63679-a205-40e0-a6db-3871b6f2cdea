...
public class ListDefinitionData implements IExtensibleDataObject {
  ...
  public ListType getType() {
    try {
      ...
      if (res == null) return null;
      return ListType.valueOf(((NEnum) res).getValueName());
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public ListDefinitionData() {
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.ListDefinitionData");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public ListDefinitionData(NObject handle) {
