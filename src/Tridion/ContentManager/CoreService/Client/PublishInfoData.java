...
public class PublishInfoData extends Info implements IExtensibleDataObject {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setPublishedAt(DateTime value) {
    try {
      javonetHandle.set("PublishedAt", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public DateTime getPublishedAt() {
    try {
      Object res = javonetHandle.<NObject>get("PublishedAt");
      if (res == null) return null;
  ...
  public void setRenderedWith(LinkToVersionedItemData value) {
    try {
      javonetHandle.set("RenderedWith", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public LinkToVersionedItemData getRenderedWith() {
    try {
      Object res = javonetHandle.<NObject>get("RenderedWith");
      if (res == null) return null;
  ...
  public void setRepository(LinkToRepositoryData value) {
    try {
      javonetHandle.set("Repository", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public LinkToUserData getUser() {
    try {
      Object res = javonetHandle.<NObject>get("User");
      if (res == null) return null;
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setTargetPurpose(java.lang.String value) {
    try {
      javonetHandle.set("TargetPurpose", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.String getTargetPurpose() {
    try {
      java.lang.String res = javonetHandle.get("TargetPurpose");
      if (res == null) return "";
  ...
  public PublishInfoData() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.PublishInfoData");
  ...
  public PublishInfoData(NObject handle) {
    super(handle);
