...
public class BluePrintNodesFilterData extends SystemWideListFilterData
  ...
  public void setForItem(LinkToRepositoryLocalObjectData value) {
    try {
      javonetHandle.set("ForItem", value);
  ...
  public LinkToRepositoryLocalObjectData getForItem() {
    try {
      Object res = javonetHandle.<NObject>get("ForItem");
  ...
  public BluePrintNodesFilterData() {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New("Tridion.ContentManager.CoreService.Client.BluePrintNodesFilterData");
  ...
  public BluePrintNodesFilterData(NObject handle) {
    super(handle);
