...
public class WeakLink implements IExtensibleDataObject {
  ...
  public WeakLink() {
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.WeakLink");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public WeakLink(NObject handle) {
