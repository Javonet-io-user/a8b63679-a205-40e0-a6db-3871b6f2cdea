...
public class TemplateData extends VersionedItemData implements IExtensibleDataObject {
  ...
  public void setParameterSchema(LinkToSchemaData value) {
    try {
      javonetHandle.set("ParameterSchema", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public LinkToSchemaData getParameterSchema() {
    try {
      Object res = javonetHandle.<NObject>get("ParameterSchema");
      if (res == null) return null;
  ...
  public void setTemplateType(java.lang.String value) {
    try {
      javonetHandle.set("TemplateType", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getTemplateType() {
    try {
      java.lang.String res = javonetHandle.get("TemplateType");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public TemplateData() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.TemplateData");
  ...
  public TemplateData(NObject handle) {
    super(handle);
