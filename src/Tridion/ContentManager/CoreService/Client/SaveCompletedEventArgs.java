...
public class SaveCompletedEventArgs extends AsyncCompletedEventArgs {
  ...
  public SaveCompletedEventArgs(
    ...
    try {
      javonetHandle =
          Javonet.New(
              "Tridion.ContentManager.CoreService.Client.SaveCompletedEventArgs",
              new Object[] {results},
              exception,
              cancelled,
              userState);
  ...
  public SaveCompletedEventArgs(NObject handle) {
    super(handle);
