...
public class ExternalUser implements IExtensibleDataObject {
  ...
  public ExternalUser() {
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.ExternalUser");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public ExternalUser(NObject handle) {
