...
public class PublishContextData implements IExtensibleDataObject {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setProcessedItems(ProcessedItemData[] value) {
    try {
      javonetHandle.set("ProcessedItems", new Object[] {value});
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public ProcessedItemData[] getProcessedItems(Class<?> returnArrayType) {
    try {
      Object[] res = javonetHandle.<NObject[]>get("ProcessedItems");
      if (res == null) return null;
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setResolvedItems(ResolvedItemData[] value) {
    try {
      javonetHandle.set("ResolvedItems", new Object[] {value});
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public ResolvedItemData[] getResolvedItems(Class<?> returnArrayType) {
    try {
      Object[] res = javonetHandle.<NObject[]>get("ResolvedItems");
      if (res == null) return null;
  ...
  public PublishContextData() {
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.PublishContextData");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public PublishContextData(NObject handle) {
