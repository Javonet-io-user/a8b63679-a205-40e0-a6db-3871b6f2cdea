...
public class ClaimMappingData implements IExtensibleDataObject {
  ...
  public LinkToGroupData getGroup() {
    try {
      ...
      if (res == null) return null;
      return new LinkToGroupData((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public ClaimMappingData() {
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.ClaimMappingData");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public ClaimMappingData(NObject handle) {
