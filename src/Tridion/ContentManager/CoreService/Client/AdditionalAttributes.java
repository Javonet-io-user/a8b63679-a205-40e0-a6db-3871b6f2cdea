...
public class AdditionalAttributes extends Dictionary<java.lang.String, java.lang.String[]>
  ...
  public AdditionalAttributes() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.AdditionalAttributes");
  ...
  public AdditionalAttributes(NObject handle) {
    super(handle);
