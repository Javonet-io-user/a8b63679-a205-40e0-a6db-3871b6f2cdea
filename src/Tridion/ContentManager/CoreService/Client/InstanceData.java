...
public class InstanceData implements IExtensibleDataObject {
  ...
  public void setContainerItem(LinkToIdentifiableObjectData value) {
    try {
      javonetHandle.set("ContainerItem", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public LinkToIdentifiableObjectData getContainerItem() {
    try {
      Object res = javonetHandle.<NObject>get("ContainerItem");
      if (res == null) return null;
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setRegion(RegionData value) {
    try {
      javonetHandle.set("Region", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public RegionData getRegion() {
    try {
      Object res = javonetHandle.<NObject>get("Region");
      if (res == null) return null;
      return new RegionData((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public InstanceData() {
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.InstanceData");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public InstanceData(NObject handle) {
