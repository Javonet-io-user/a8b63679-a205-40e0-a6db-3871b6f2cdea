...
public class ExtensionPropertyDictionary extends Dictionary<java.lang.String, java.lang.String>
  ...
  public ExtensionPropertyDictionary() {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New("Tridion.ContentManager.CoreService.Client.ExtensionPropertyDictionary");
  ...
  public ExtensionPropertyDictionary(NObject handle) {
    super(handle);
