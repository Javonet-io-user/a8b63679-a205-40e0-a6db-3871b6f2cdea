...
public class WorkflowInfo extends Info implements IExtensibleDataObject {
  protected NObject javonetHandle;
  /** SetProperty */
  @MethodTypeAnnotation(type = "SetField")
  public void setActivityDefinitionDescription(java.lang.String value) {
    try {
      javonetHandle.set("ActivityDefinitionDescription", value);
  ...
  public java.lang.String getActivityDefinitionDescription() {
    try {
      java.lang.String res = javonetHandle.get("ActivityDefinitionDescription");
      if (res == null) return "";
  ...
  public void setActivityInstance(LinkToActivityInstanceData value) {
    try {
      javonetHandle.set("ActivityInstance", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public LinkToActivityInstanceData getActivityInstance() {
    try {
      Object res = javonetHandle.<NObject>get("ActivityInstance");
      if (res == null) return null;
      return new LinkToActivityInstanceData((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setPreviousMessage(java.lang.String value) {
    try {
      javonetHandle.set("PreviousMessage", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.String getPreviousMessage() {
    try {
      java.lang.String res = javonetHandle.get("PreviousMessage");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public void setProcessInstance(LinkToProcessInstanceData value) {
    try {
      javonetHandle.set("ProcessInstance", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public LinkToProcessInstanceData getProcessInstance() {
    try {
      Object res = javonetHandle.<NObject>get("ProcessInstance");
      if (res == null) return null;
      return new LinkToProcessInstanceData((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public WorkflowInfo() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.WorkflowInfo");
  ...
  public WorkflowInfo(NObject handle) {
    super(handle);
