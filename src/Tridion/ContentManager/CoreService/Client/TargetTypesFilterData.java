...
public class TargetTypesFilterData extends SystemWideListFilterData
  ...
  public TargetTypesFilterData() {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New("Tridion.ContentManager.CoreService.Client.TargetTypesFilterData");
  ...
  public TargetTypesFilterData(NObject handle) {
    super(handle);
