...
public class SecurityDescriptorData implements IExtensibleDataObject {
  ...
  public void setRights(Rights value) {
    try {
      javonetHandle.set("Rights", NEnum.fromJavaEnum(value));
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public Rights getRights() {
    try {
      Object res = javonetHandle.<NEnum>get("Rights");
      if (res == null) return null;
  ...
  public SecurityDescriptorData() {
    try {
      javonetHandle =
          Javonet.New("Tridion.ContentManager.CoreService.Client.SecurityDescriptorData");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public SecurityDescriptorData(NObject handle) {
