...
public class StartWorkflowInstructionData implements IExtensibleDataObject {
  ...
  public void setActivityTitle(java.lang.String value) {
    try {
      javonetHandle.set("ActivityTitle", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getActivityTitle() {
    try {
      java.lang.String res = javonetHandle.get("ActivityTitle");
      if (res == null) return "";
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setProcessInstanceTitle(java.lang.String value) {
    try {
      javonetHandle.set("ProcessInstanceTitle", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.String getProcessInstanceTitle() {
    try {
      java.lang.String res = javonetHandle.get("ProcessInstanceTitle");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public StartWorkflowInstructionData() {
    try {
      javonetHandle =
          Javonet.New("Tridion.ContentManager.CoreService.Client.StartWorkflowInstructionData");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public StartWorkflowInstructionData(NObject handle) {
