...
public class MultimediaLinkFieldDefinitionData extends ItemFieldDefinitionData
  ...
  public MultimediaLinkFieldDefinitionData() {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New(
              "Tridion.ContentManager.CoreService.Client.MultimediaLinkFieldDefinitionData");
  ...
  public MultimediaLinkFieldDefinitionData(NObject handle) {
    super(handle);
