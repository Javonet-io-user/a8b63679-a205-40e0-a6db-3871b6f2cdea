...
public class ResolvedItemData implements IExtensibleDataObject {
  ...
  public void setTemplate(LinkToTemplateData value) {
    try {
      javonetHandle.set("Template", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public LinkToTemplateData getTemplate() {
    try {
      ...
      if (res == null) return null;
      return new LinkToTemplateData((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public ResolvedItemData() {
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.ResolvedItemData");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public ResolvedItemData(NObject handle) {
