...
public class WhereUsedFilterData extends SubjectRelatedListFilterData
  ...
  public void setInRepository(LinkToRepositoryData value) {
    try {
      javonetHandle.set("InRepository", value);
  ...
  public LinkToRepositoryData getInRepository() {
    try {
      Object res = javonetHandle.<NObject>get("InRepository");
  ...
  public WhereUsedFilterData() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.WhereUsedFilterData");
  ...
  public WhereUsedFilterData(NObject handle) {
    super(handle);
