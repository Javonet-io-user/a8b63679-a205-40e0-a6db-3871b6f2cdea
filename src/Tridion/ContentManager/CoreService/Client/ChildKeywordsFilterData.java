...
public class ChildKeywordsFilterData extends KeywordRelatedFilterData
  ...
  public void setInCategory(LinkToCategoryData value) {
    try {
      javonetHandle.set("InCategory", value);
  ...
  public LinkToCategoryData getInCategory() {
    try {
      Object res = javonetHandle.<NObject>get("InCategory");
  ...
  public ChildKeywordsFilterData() {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New("Tridion.ContentManager.CoreService.Client.ChildKeywordsFilterData");
  ...
  public ChildKeywordsFilterData(NObject handle) {
    super(handle);
