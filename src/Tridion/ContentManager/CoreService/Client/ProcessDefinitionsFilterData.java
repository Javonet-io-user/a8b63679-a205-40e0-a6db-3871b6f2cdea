...
public class ProcessDefinitionsFilterData extends WorkflowManagerFilterData
  ...
  public ProcessDefinitionsFilterData() {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New("Tridion.ContentManager.CoreService.Client.ProcessDefinitionsFilterData");
  ...
  public ProcessDefinitionsFilterData(NObject handle) {
    super(handle);
