...
public class WebDavFileExtensionMapping implements IExtensibleDataObject {
  ...
  public WebDavFileExtensionMapping() {
    try {
      javonetHandle =
          Javonet.New("Tridion.ContentManager.CoreService.Client.WebDavFileExtensionMapping");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public WebDavFileExtensionMapping(NObject handle) {
