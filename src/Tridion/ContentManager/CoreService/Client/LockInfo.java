...
public class LockInfo extends Info implements IExtensibleDataObject {
  protected NObject javonetHandle;
  /** SetProperty */
  @MethodTypeAnnotation(type = "SetField")
  public void setLockDate(Nullable<DateTime> value) {
    try {
      javonetHandle.set("LockDate", value);
  ...
  public Nullable<DateTime> getLockDate() {
    try {
      Object res = javonetHandle.<NObject>get("LockDate");
  ...
  public LockInfo() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.LockInfo");
  ...
  public LockInfo(NObject handle) {
    super(handle);
