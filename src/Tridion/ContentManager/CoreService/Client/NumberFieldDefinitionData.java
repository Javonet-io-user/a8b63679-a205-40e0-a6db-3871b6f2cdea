...
public class NumberFieldDefinitionData extends ItemFieldDefinitionData
    implements IExtensibleDataObject {
  protected NObject javonetHandle;
  /** SetProperty */
  @MethodTypeAnnotation(type = "SetField")
  public void setDefaultValue(Nullable<java.lang.Double> value) {
    try {
  ...
  public Nullable<java.lang.Double> getDefaultValue() {
    try {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setFractionDigits(Nullable<java.lang.Integer> value) {
    try {
      javonetHandle.set("FractionDigits", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public Nullable<java.lang.Integer> getFractionDigits() {
    try {
      Object res = javonetHandle.<NObject>get("FractionDigits");
      if (res == null) return null;
  ...
  public NumberListDefinitionData getList() {
    try {
      ...
      if (res == null) return null;
      return new NumberListDefinitionData((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setMaxValue(Nullable<java.lang.Double> value) {
    try {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public Nullable<java.lang.Double> getMaxValue() {
    try {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setMinValue(Nullable<java.lang.Double> value) {
    try {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public Nullable<java.lang.Double> getMinValue() {
    try {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setTotalDigits(Nullable<java.lang.Integer> value) {
    try {
      javonetHandle.set("TotalDigits", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public Nullable<java.lang.Integer> getTotalDigits() {
    try {
      Object res = javonetHandle.<NObject>get("TotalDigits");
      if (res == null) return null;
      return new Nullable<java.lang.Integer>((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public NumberFieldDefinitionData() {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New("Tridion.ContentManager.CoreService.Client.NumberFieldDefinitionData");
  ...
  public NumberFieldDefinitionData(NObject handle) {
    super(handle);
