...
public class PublicationType implements IExtensibleDataObject {
  ...
  public PublicationType() {
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.PublicationType");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public PublicationType(NObject handle) {
