...
public class Link implements IExtensibleDataObject {
  ...
  public java.lang.String getIdRef() {
    try {
      java.lang.String res = javonetHandle.get("IdRef");
      if (res == null) return "";
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setWebDavUrl(java.lang.String value) {
    try {
      javonetHandle.set("WebDavUrl", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getWebDavUrl() {
    try {
      java.lang.String res = javonetHandle.get("WebDavUrl");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public Link() {
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.Link");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public Link(NObject handle) {
