...
public class GroupMembershipData implements IExtensibleDataObject {
  ...
  public GroupMembershipData() {
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.GroupMembershipData");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public GroupMembershipData(NObject handle) {
