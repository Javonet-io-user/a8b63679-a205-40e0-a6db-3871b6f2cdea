...
public class ArrayOfTcmUri extends List<java.lang.String>
  ...
  public ArrayOfTcmUri() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.ArrayOfTcmUri");
  ...
  public ArrayOfTcmUri(NObject handle) {
    super(handle);
