...
public class ProcessInstanceData extends ProcessData implements IExtensibleDataObject {
  ...
  public void setVariables(VariablesDictionary value) {
    try {
      javonetHandle.set("Variables", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public VariablesDictionary getVariables() {
    try {
      ...
      if (res == null) return null;
      return new VariablesDictionary((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public ProcessInstanceData() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.ProcessInstanceData");
  ...
  public ProcessInstanceData(NObject handle) {
    super(handle);
