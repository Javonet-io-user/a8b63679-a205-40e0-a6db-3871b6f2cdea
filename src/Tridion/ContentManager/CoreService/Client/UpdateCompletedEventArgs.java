...
public class UpdateCompletedEventArgs extends AsyncCompletedEventArgs {
  ...
  public UpdateCompletedEventArgs(
    ...
    try {
      javonetHandle =
          Javonet.New(
              "Tridion.ContentManager.CoreService.Client.UpdateCompletedEventArgs",
              new Object[] {results},
              exception,
              cancelled,
              userState);
  ...
  public UpdateCompletedEventArgs(NObject handle) {
    super(handle);
