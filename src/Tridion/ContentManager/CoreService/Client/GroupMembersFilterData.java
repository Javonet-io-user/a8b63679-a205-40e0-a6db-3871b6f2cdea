...
public class GroupMembersFilterData extends SubjectRelatedListFilterData
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setExcludeDisabledTrustees(Nullable<java.lang.Boolean> value) {
    try {
      javonetHandle.set("ExcludeDisabledTrustees", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public Nullable<java.lang.Boolean> getExcludeDisabledTrustees() {
    try {
      Object res = javonetHandle.<NObject>get("ExcludeDisabledTrustees");
      if (res == null) return null;
  ...
  public GroupMembersFilterData() {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New("Tridion.ContentManager.CoreService.Client.GroupMembersFilterData");
  ...
  public GroupMembersFilterData(NObject handle) {
    super(handle);
