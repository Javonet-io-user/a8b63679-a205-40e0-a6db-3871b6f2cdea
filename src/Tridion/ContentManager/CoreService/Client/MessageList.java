...
public class MessageList extends List<java.lang.String>
  ...
  public MessageList() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.MessageList");
  ...
  public MessageList(NObject handle) {
    super(handle);
