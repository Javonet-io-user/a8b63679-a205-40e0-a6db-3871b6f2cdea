...
public class TridionEnumValue implements IExtensibleDataObject {
  ...
  public TridionEnumValue() {
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.TridionEnumValue");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public TridionEnumValue(NObject handle) {
