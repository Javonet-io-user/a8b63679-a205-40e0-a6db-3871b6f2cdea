...
public class ContainingBundlesListInfo extends ListInfo implements IExtensibleDataObject {
  ...
  public ContainingBundlesListInfo() {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New("Tridion.ContentManager.CoreService.Client.ContainingBundlesListInfo");
  ...
  public ContainingBundlesListInfo(NObject handle) {
    super(handle);
