...
public class SystemPrivilege implements IExtensibleDataObject {
  ...
  public SystemPrivilege() {
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.SystemPrivilege");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public SystemPrivilege(NObject handle) {
