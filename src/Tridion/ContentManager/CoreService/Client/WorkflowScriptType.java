...
public class WorkflowScriptType implements IExtensibleDataObject {
  ...
  public WorkflowScriptType() {
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.WorkflowScriptType");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public WorkflowScriptType(NObject handle) {
