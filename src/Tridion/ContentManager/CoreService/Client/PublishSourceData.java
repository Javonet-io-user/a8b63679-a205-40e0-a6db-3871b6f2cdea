...
public class PublishSourceData implements IExtensibleDataObject {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setContextPublication(LinkToPublicationData value) {
    try {
      javonetHandle.set("ContextPublication", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public LinkToPublicationData getContextPublication() {
    try {
      Object res = javonetHandle.<NObject>get("ContextPublication");
      if (res == null) return null;
  ...
  public PublishSourceData() {
    try {
      javonetHandle = Javonet.New("Tridion.ContentManager.CoreService.Client.PublishSourceData");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public PublishSourceData(NObject handle) {
