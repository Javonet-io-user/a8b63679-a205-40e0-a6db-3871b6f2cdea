...
public class TemplateBuildingBlockData extends TemplateData implements IExtensibleDataObject {
  ...
  public TemplateBuildingBlockData() {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New("Tridion.ContentManager.CoreService.Client.TemplateBuildingBlockData");
  ...
  public TemplateBuildingBlockData(NObject handle) {
    super(handle);
